...
class Environment:
    def __init__(self, dataset, interactor, init_bankroll=1000, min_bet=5, max_bet=100):
        ...
        self.bet_cols = ['BetH', 'BetA']
        self.odds_cols = ['OddsH', 'OddsA']
        self.score_cols = ['HSC', 'ASC']
        self.feat_cols = ['S_H', 'PPG_H', 'PIM_H', 'FOW_H', 'S_A', 'PPG_A', 'PIM_A', 'FOW_A']
        self.res_cols = ['H', 'A']
    ...
    def get_opps(self, date):
        ...
        return opps.drop(self.label_cols + self.feat_cols, axis=1)
